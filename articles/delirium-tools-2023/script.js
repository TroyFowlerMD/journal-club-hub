/* ============================================================
   Delirium Assessment Tools — Journal Club Dashboard
...
(function () {
  ...
  /* --- Tools Compared Sub-Tabs --- */
  document.querySelectorAll('.subsection-tabs').forEach(tabContainer => {
    tabContainer.addEventListener('click', e => {
      ...
      // Deactivate all tabs and panels within this tab group's parent
      const section = tabContainer.closest('.section-body') || tabContainer.parentElement;
      tabContainer.querySelectorAll('.subsection-tab').forEach(t => {
        t.classList.remove('active');
        t.setAttribute('aria-selected', 'false');
      });
      section.querySelectorAll('.subsection-panel').forEach(p => p.classList.remove('active'));
