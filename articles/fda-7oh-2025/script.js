/* ============================================================
   7-OH Journal Club Dashboard — Interactive Behavior
   ============================================================ */
...
(function () {
  ...
  /* --- Key Findings Sub-Tabs --- */
  const tabContainer = document.querySelector('.subsection-tabs');
  if (tabContainer) {
    tabContainer.addEventListener('click', e => {
      ...
      document.querySelectorAll('.subsection-panel').forEach(p => p.classList.remove('active'));
